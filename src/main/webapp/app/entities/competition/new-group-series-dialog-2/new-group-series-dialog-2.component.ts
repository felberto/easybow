...
@Component({
  ...
  templateUrl: './new-group-series-dialog-2.component.html',
  styleUrls: ['./new-group-series-dialog-2.component.scss'],
})
export class NewGroupSeriesDialog2Component implements OnInit {
