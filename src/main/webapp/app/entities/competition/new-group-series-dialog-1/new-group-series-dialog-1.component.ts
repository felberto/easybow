...
@Component({
  ...
  templateUrl: './new-group-series-dialog-1.component.html',
  styleUrls: ['./new-group-series-dialog-1.component.scss'],
})
export class NewGroupSeriesDialog1Component implements OnInit {
