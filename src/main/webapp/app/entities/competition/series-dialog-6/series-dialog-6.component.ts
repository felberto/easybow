...
@Component({
  selector: 'jhi-series-dialog-6',
  templateUrl: './series-dialog-6.component.html',
  styleUrls: ['./series-dialog-6.component.scss'],
})
export class SeriesDialog6Component implements OnInit {
  ...
  testForm = new FormGroup({
    ...
    number41: new FormControl(),
    number42: new FormControl(),
    number43: new FormControl(),
    number44: new FormControl(),
    number45: new FormControl(),
    number46: new FormControl(),
    number47: new FormControl(),
    number48: new FormControl(),
    number49: new FormControl(),
    number50: new FormControl(),
    number51: new FormControl(),
    number52: new FormControl(),
    number53: new FormControl(),
    number54: new FormControl(),
    number55: new FormControl(),
    number56: new FormControl(),
    number57: new FormControl(),
    number58: new FormControl(),
    number59: new FormControl(),
    number60: new FormControl(),
  });
      ...
      this.competitionService.find(this.result.competition.id).subscribe(
        result => {
          ...
          this.resultsService.find(<number>this.result?.id).subscribe(r => {
            ...
            // serie5
            this.serie5.push(<number>this.result?.serie5?.p1);
            this.serie5.push(<number>this.result?.serie5?.p2);
            this.serie5.push(<number>this.result?.serie5?.p3);
            this.serie5.push(<number>this.result?.serie5?.p4);
            this.serie5.push(<number>this.result?.serie5?.p5);
            this.serie5.push(<number>this.result?.serie5?.p6);
            this.serie5.push(<number>this.result?.serie5?.p7);
            this.serie5.push(<number>this.result?.serie5?.p8);
            this.serie5.push(<number>this.result?.serie5?.p9);
            this.serie5.push(<number>this.result?.serie5?.p10);
            // serie6
            this.serie6.push(<number>this.result?.serie6?.p1);
            this.serie6.push(<number>this.result?.serie6?.p2);
            this.serie6.push(<number>this.result?.serie6?.p3);
            this.serie6.push(<number>this.result?.serie6?.p4);
            this.serie6.push(<number>this.result?.serie6?.p5);
            this.serie6.push(<number>this.result?.serie6?.p6);
            this.serie6.push(<number>this.result?.serie6?.p7);
            this.serie6.push(<number>this.result?.serie6?.p8);
            this.serie6.push(<number>this.result?.serie6?.p9);
            this.serie6.push(<number>this.result?.serie6?.p10);
            // set form values
            this.testForm.setValue({
              ...
              number41: this.result?.serie5?.p1,
              number42: this.result?.serie5?.p2,
              number43: this.result?.serie5?.p3,
              number44: this.result?.serie5?.p4,
              number45: this.result?.serie5?.p5,
              number46: this.result?.serie5?.p6,
              number47: this.result?.serie5?.p7,
              number48: this.result?.serie5?.p8,
              number49: this.result?.serie5?.p9,
              number50: this.result?.serie5?.p10,
              number51: this.result?.serie6?.p1,
              number52: this.result?.serie6?.p2,
              number53: this.result?.serie6?.p3,
              number54: this.result?.serie6?.p4,
              number55: this.result?.serie6?.p5,
              number56: this.result?.serie6?.p6,
              number57: this.result?.serie6?.p7,
              number58: this.result?.serie6?.p8,
              number59: this.result?.serie6?.p9,
              number60: this.result?.serie6?.p10,
            });
          });
        },
  ...
  save(): void {
    ...
    this.updateSerieOnResult(this.result?.serie5, this.serie5, 5);
    this.updateSerieOnResult(this.result?.serie6, this.serie6, 6);
    this.saveResult();
    this.cancel();
  }
  ...
  updateSerieOnResult(serie: ISeries | null | undefined, numbers: number[], serieNumber: number): void {
    ...
    switch (serieNumber) {
      ...
      case 4:
        ...
        break;
      case 5:
        if (this.result?.serie5 !== undefined) {
          this.result.serie5 = iSeries;
        }
        break;
      case 6:
        if (this.result?.serie6 !== undefined) {
          this.result.serie6 = iSeries;
        }
        break;
    }
  }
  ...
  getSerie(serieNumber: number): number[] {
    ...
    } else if (serieNumber === 5) {
      serie.push(
        this.testForm.get('number41')!.value,
        this.testForm.get('number42')!.value,
        this.testForm.get('number43')!.value,
        this.testForm.get('number44')!.value,
        this.testForm.get('number45')!.value,
        this.testForm.get('number46')!.value,
        this.testForm.get('number47')!.value,
        this.testForm.get('number48')!.value,
        this.testForm.get('number49')!.value,
        this.testForm.get('number50')!.value
      );
    } else if (serieNumber === 6) {
      serie.push(
        this.testForm.get('number51')!.value,
        this.testForm.get('number52')!.value,
        this.testForm.get('number53')!.value,
        this.testForm.get('number54')!.value,
        this.testForm.get('number55')!.value,
        this.testForm.get('number56')!.value,
        this.testForm.get('number57')!.value,
        this.testForm.get('number58')!.value,
        this.testForm.get('number59')!.value,
        this.testForm.get('number60')!.value
      );
    }
  ...
  getSum(): any {
    ...
    this.serie5 = this.getSerie(5);
    this.serie6 = this.getSerie(6);
    if (
      this.serie1.includes(11) ||
      this.serie2.includes(11) ||
      this.serie3.includes(11) ||
      this.serie4.includes(11) ||
      this.serie5.includes(11) ||
      this.serie6.includes(11)
    ) {
      let tempSerie1: number[] = [];
      let tempSerie2: number[] = [];
      let tempSerie3: number[] = [];
      let tempSerie4: number[] = [];
      let tempSerie5: number[] = [];
      let tempSerie6: number[] = [];
      ...
      tempSerie5 = this.replacingElmnts(this.serie5, 11, 10);
      tempSerie6 = this.replacingElmnts(this.serie6, 11, 10);
      return (
        tempSerie1.reduce((a, b) => a + b, 0) +
        tempSerie2.reduce((a, b) => a + b, 0) +
        tempSerie3.reduce((a, b) => a + b, 0) +
        tempSerie4.reduce((a, b) => a + b, 0) +
        tempSerie5.reduce((a, b) => a + b, 0) +
        tempSerie6.reduce((a, b) => a + b, 0)
      );
    } else {
      return (
        ...
        this.serie5.reduce((a, b) => a + b, 0) +
        this.serie6.reduce((a, b) => a + b, 0)
      );
    }
  }
