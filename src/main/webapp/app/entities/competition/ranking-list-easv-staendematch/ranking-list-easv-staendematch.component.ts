...
@Component({
  selector: 'jhi-ranking-list-easv-staendematch',
  templateUrl: './ranking-list-easv-staendematch.component.html',
  styleUrls: ['./ranking-list-easv-staendematch.component.scss'],
})
export class RankingListEasvStaendematchComponent implements OnInit {
