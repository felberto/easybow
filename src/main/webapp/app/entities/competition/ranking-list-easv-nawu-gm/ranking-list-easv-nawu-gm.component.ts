...
@Component({
  selector: 'jhi-ranking-list-easv-nawu-gm',
  templateUrl: './ranking-list-easv-nawu-gm.component.html',
  styleUrls: ['./ranking-list-easv-nawu-gm.component.scss'],
})
export class RankingListEasvNawuGmComponent implements OnInit {
