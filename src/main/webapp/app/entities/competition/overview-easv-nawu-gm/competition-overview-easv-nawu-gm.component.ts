...
@Component({
  selector: 'jhi-overview-easv-nawu-gm',
  templateUrl: './competition-overview-easv-nawu-gm.component.html',
  styleUrls: ['./competition-overview-easv-nawu-gm.component.scss'],
})
export class CompetitionOverviewEasvNawuGmComponent implements OnInit {
