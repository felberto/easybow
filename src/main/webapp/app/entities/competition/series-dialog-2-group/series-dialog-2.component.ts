...
@Component({
  selector: 'jhi-series-dialog-2-group',
  templateUrl: './series-dialog-2-group.component.html',
  styleUrls: ['./series-dialog-2-group.component.scss'],
})
export class SeriesDialog2GroupComponent implements OnInit {
  ...
  ngOnInit(): void {
    //todo wenn vorhanden resultate für gruppe holen und anzeigen, sonst leer und neue erstellen
