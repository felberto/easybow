...
@Component({
  selector: 'jhi-overview-easv-verbaendefinal',
  templateUrl: './competition-overview-easv-verbaendefinal.component.html',
  styleUrls: ['./competition-overview-easv-verbaendefinal.component.scss'],
})
export class CompetitionOverviewEasvVerbaendefinalComponent implements OnInit {
