...
@Component({
  selector: 'jhi-view-easv-staendematch',
  templateUrl: './live-easv-staendematch.component.html',
  styleUrls: ['./live-easv-staendematch.component.scss'],
})
export class LiveEasvStaendematchComponent implements OnInit {
