...
@Component({
  selector: 'jhi-view-easv-sm-10m',
  templateUrl: './live-easv-sm-10m.component.html',
  styleUrls: ['./live-easv-sm-10m.component.scss'],
})
export class LiveEasvSm10mComponent implements OnInit {
