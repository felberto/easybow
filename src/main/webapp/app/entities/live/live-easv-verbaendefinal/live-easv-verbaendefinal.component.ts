...
@Component({
  selector: 'jhi-view-easv-verbaendefinal',
  templateUrl: './live-easv-verbaendefinal.component.html',
  styleUrls: ['./live-easv-verbaendefinal.component.scss'],
})
export class LiveEasvVerbaendefinalComponent implements OnInit {
