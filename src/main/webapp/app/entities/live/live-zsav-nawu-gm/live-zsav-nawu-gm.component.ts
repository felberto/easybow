...
@Component({
  selector: 'jhi-view-zsav-nawu-gm',
  templateUrl: './live-zsav-nawu-gm.component.html',
  styleUrls: ['./live-zsav-nawu-gm.component.scss'],
})
export class LiveZsavNawuGmComponent implements OnInit {
