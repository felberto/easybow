...
/**
 * Service Implementation for managing {@link RankingListService} for competitionType EASV_WORLDCUP_30M.
 */
@Service
@Transactional
public class EasvWorldcup30mRankingListServiceImpl {

    private final Logger log = LoggerFactory.getLogger(EasvWorldcup30mRankingListServiceImpl.class);

    private final ResultsRepository resultsRepository;

    private final CompetitionRepository competitionRepository;

    public EasvWorldcup30mRankingListServiceImpl(ResultsRepository resultsRepository, CompetitionRepository competitionRepository) {
