...
/**
 * Service Implementation for managing {@link RankingListService} for competitionType EASV_STAENDEMATCH.
 */
@Service
@Transactional
public class EasvStaendematchGroupRankingListServiceImpl {

    private final Logger log = LoggerFactory.getLogger(EasvStaendematchGroupRankingListServiceImpl.class);
    ...
    public EasvStaendematchGroupRankingListServiceImpl(
    ...
    public RankingList generateRankingList(Long competitionId, Integer type) {
        ...
        sortRankingListRound1Series6(rankingList);
                    ...
                    athlete -> {
                        ...
                        resultsAthlete.forEach(
                            result -> {
                                ...
                                athleteResult.setResultatRunde1Passe5(checkIfNull(result.getSerie5()));
                                athleteResult.setResultatRunde1Passe6(checkIfNull(result.getSerie6()));
                                athleteResult.setT0(
                                    athleteResult.getT0() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 0) +
                                    getDeepshotsForSerie(result.getSerie6(), 0)
                                );
                                athleteResult.setT1(
                                    athleteResult.getT1() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 1) +
                                    getDeepshotsForSerie(result.getSerie6(), 1)
                                );
                                athleteResult.setT2(
                                    athleteResult.getT2() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 2) +
                                    getDeepshotsForSerie(result.getSerie6(), 2)
                                );
                                athleteResult.setT3(
                                    athleteResult.getT3() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 3) +
                                    getDeepshotsForSerie(result.getSerie6(), 3)
                                );
                                athleteResult.setT4(
                                    athleteResult.getT4() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 4) +
                                    getDeepshotsForSerie(result.getSerie6(), 4)
                                );
                                athleteResult.setT5(
                                    athleteResult.getT5() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 5) +
                                    getDeepshotsForSerie(result.getSerie6(), 5)
                                );
                                athleteResult.setT6(
                                    athleteResult.getT6() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 6) +
                                    getDeepshotsForSerie(result.getSerie6(), 6)
                                );
                                athleteResult.setT7(
                                    athleteResult.getT7() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 7) +
                                    getDeepshotsForSerie(result.getSerie6(), 7)
                                );
                                athleteResult.setT8(
                                    athleteResult.getT8() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 8) +
                                    getDeepshotsForSerie(result.getSerie6(), 8)
                                );
                                athleteResult.setT9(
                                    athleteResult.getT9() +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 9) +
                                    getDeepshotsForSerie(result.getSerie6(), 9)
                                );
                                athleteResult.setT10(
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 10) +
                                    getDeepshotsForSerie(result.getSerie6(), 10) +
                                    ...
                                    getDeepshotsForSerie(result.getSerie5(), 11) +
                                    getDeepshotsForSerie(result.getSerie6(), 11)
                                );
    ...
    public GroupRankingList sortRankingListFinalSeries6(GroupRankingList groupRankingList) {
        groupRankingList
    ...
    public RankingList sortRankingListRound1Series6(RankingList rankingList) {
        /*
            ...
            .sort(
                (o1, o2) ->
                    ComparisonChain
                        ...
                        .compare(o2.getResult(), o1.getResult())
                        //Resultat Passe 6
                        .compare(checkIfNull(o2.getResultsList().get(0).getSerie6()), checkIfNull(o1.getResultsList().get(0).getSerie6()))
                        //Resultat Passe 5
                        .compare(checkIfNull(o2.getResultsList().get(0).getSerie5()), checkIfNull(o1.getResultsList().get(0).getSerie5()))
                        //Resultat Passe 4
