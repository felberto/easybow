...
/**
 * Service Implementation for managing {@link RankingListService} for competitionType EASV_NAWU_GM.
 */
@Service
@Transactional
public class EasvNawuGmRankingListServiceImpl {

    private final Logger log = LoggerFactory.getLogger(EasvNawuGmRankingListServiceImpl.class);
    ...
    public EasvNawuGmRankingListServiceImpl(
