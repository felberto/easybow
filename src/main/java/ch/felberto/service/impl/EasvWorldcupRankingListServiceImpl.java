...
/**
 * Service Implementation for managing {@link RankingListService} for competitionType EASV_WORLDCUP.
 */
@Service
@Transactional
public class EasvWorldcupRankingListServiceImpl {

    private final Logger log = LoggerFactory.getLogger(EasvWorldcupRankingListServiceImpl.class);

    private final ResultsRepository resultsRepository;

    private final CompetitionRepository competitionRepository;

    public EasvWorldcupRankingListServiceImpl(ResultsRepository resultsRepository, CompetitionRepository competitionRepository) {
    ...
    public RankingList generateRankingList(Long competitionId, Integer type) {
        ...
        //type is here gender (1 = male / 2 = female)
    ...
    public RankingList getAllAthletesByCompetition(Competition competition, Integer type) {
        ...
        athleteList
            ...
            .filter(
                athlete -> {
                    if (type == 1) {
                        return athlete.getGender() == (Gender.MALE);
                    } else if (type == 2) {
