...
/**
 * Service Implementation for managing {@link RankingListService} for competitionType EASV_VERBAENDEFINAL.
 */
@Service
@Transactional
public class EasvVerbaendefinalGroupRankingListServiceImpl {

    private final Logger log = LoggerFactory.getLogger(EasvVerbaendefinalGroupRankingListServiceImpl.class);
    ...
    public EasvVerbaendefinalGroupRankingListServiceImpl(
