...
/**
 * Criteria class for the {@link ch.felberto.domain.Passen} entity. This class is used
 * in {@link ch.felberto.web.rest.PassenResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /passens?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PassenCriteria implements Serializable, Criteria {
    ...
    public PassenCriteria() {}

    public PassenCriteria(PassenCriteria other) {
    ...
    @Override
    public PassenCriteria copy() {
        return new PassenCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PassenCriteria that = (PassenCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, resultat);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "PassenCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (p1 != null ? "p1=" + p1 + ", " : "") +
            (p2 != null ? "p2=" + p2 + ", " : "") +
            (p3 != null ? "p3=" + p3 + ", " : "") +
